...
public final class Constants {
    ...
    */
    ...
    public static final class Snxbest {
        ...
        public static final String API_V1_FOOD_PRODUCT_DATA_URL_TEMPLATE = "https://snxbest.naver.com/api/v1/snxbest/keyword/rank/%d?showAd=true&channel=m.nplusstore.best.keyword.popular&stmsId=100410832&areaCode=bkeypop&ymd=%s"; // %d = 2177000359, %s = ymd = syncDate
    }
